...
open class PointerSpeedometer @JvmOverloads constructor(
    ...
    override fun defaultSpeedometerValues() {
        super.marksNumber = 8
        super.marksPadding = 0f
        super.markStyle = Style.ROUND
        super.markHeight = dpTOpx(9f)
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        canvas.drawArc(speedometerRect, getStartDegree() + roundAngle, (getEndDegree() - getStartDegree()) - roundAngle * 2f, false, speedometerPaint)
