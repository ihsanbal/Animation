...
abstract class Speedometer @JvmOverloads constructor(
    ...
    private var startDegree = 180
    private var endDegree = 360
...
//        indicator = NoIndicator(context)
    ...
    protected fun drawMarks(canvas: Canvas) {
        ...
        val everyDegree = arrayListOf(0f, 45f, 90f, 135f, 180f)
        everyDegree.forEachIndexed { index, degree ->
